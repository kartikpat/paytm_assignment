...
export const getLaunches = ({ limit = 100, isServer = true, ...rest }) => (dispatch) => {
  ...
  if (rest[filterType.SUCCESSFUL_LANDING]) apiParams[filterType.SUCCESSFUL_LANDING] = rest[filterType.SUCCESSFUL_LANDING] === 'True';
  if (rest[filterType.SUCCESSFUL_LAUNCH]) apiParams[filterType.SUCCESSFUL_LAUNCH] = rest[filterType.SUCCESSFUL_LAUNCH] === 'True';
